...
<html>
   ...
   <body>
      <div class="wrapper ">
         <div class="mimezisi">
            <div class="row" >
               <div id="sad" style="position:absolute"><img src="1sad.gif"></div>
               <div id="happy" style="position:absolute" ><img src="1hepi.gif"></div>
            </div>
         ...
         <div>
            <?php
               echo "<form style='margin-left:5px; height= 100px;' name=\"edit\" action=\"action.php\" method=\"GET\">";
               	...
               	foreach ($json_a as $item => $task) {
               		if ($task['status'] == "open") {	
               			...
               			echo " <a style='float: right; width:32px; height:30.5px; background-color:pink;margin-top:-6px; 
                              margin-right: -1px;border-width:1px;border-style: solid; border-color:pink; margin-right:-38px; ' href=\"action.php?id=" .$item. "&action=delete\"></a>  ";
               			echo "</li>";}	}
               	if($havetasks > 0) {          
